...
public class MapsActivity extends FragmentActivity {
    ...
    private class CallToServer extends AsyncTask<String, Void, JSONArray> {

        @Override
        protected JSONArray doInBackground(String... params) {
            _rest = new DAO();
            JSONArray array = _rest.getAllRequest();
            return array;
        }
        ...
        try {
            ...
            for(int i=0 ; i<array.length() ; i++){
                ...
                mMap.addMarker(new MarkerOptions()
                        .position(new LatLng(req.getLocation().Latitude, req.getLocation().Longitude))
